...
<div id="layout">
	<div id="header">
    	<div id="logo">FLCMS <em><?php echo ($site["version"]); ?></em></div>
    </div>
    <div id="wrapper">
    	<div id="headline">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><div class="artBody">
            	<h2><a href="<?php echo U('index/showArti');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h2>
                <div class="dots"></div>
                <span class="details">
                	发布于<?php echo ($vo["time"]); ?> By <?php echo ($vo["name"]); ?>  分类: <a href="<?php echo U('index/showCate');?>?id=<?php echo ($vo["category_id"]); ?>" title="<?php echo ($vo["category_name"]); ?>" rel="category"><?php echo ($vo["category_name"]); ?></a>
                </span>
                <div class="p"><?php echo cutText($vo['content'],200);?></div>
