...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="wrapper">
        	<div id="maintitle">
            	<span id="thistitle">>>管理分类</span>
            	<a class="floatright" href="<?php echo U('global/logout');?>">注销</a>
	            <span class="floatright">欢迎您！<?php echo $_SESSION["UserName"];?>  </span>
            </div>
            <div id="main">
              <table width="100%" id="listtable" border="1" align="center" cellpadding="0"  cellspacing="0">
                <tr>
                  <th width="16%" scope="col">编号</th>
                  <th width="38%" scope="col">类别名</th>
                  <th width="27%" scope="col">创建时间</th>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
                  ...
                  <td><a href="<?php echo U('category/edit');?>?id=<?php echo ($vo["id"]); ?>">编辑</a>/<a href="<?php echo U('category/delete');?>?id=<?php echo ($vo["id"]); ?>">删除</a></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
              </table>
              <div class="left"><a href="<?php echo U('category/add');?>">增加分类</a></div>
